 ...
 *
 * Implementations may consult a local JWK Set
 * ({@see \Medzuch\Jwt\Key\Resolver\StaticJwkSetResolver}), a remote
 * `jwks_uri` ({@see \Medzuch\Jwt\Key\Resolver\RemoteJwksResolver}), a
 * database, etc. The header value passed in is the parsed, already-validated
 * protected header — never re-decode from raw bytes inside a resolver.
 *
