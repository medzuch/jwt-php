...
/**
 * php-fuzzer target — the JWS JSON Serialization deserializer (no crypto).
 *
 * {@see JsonSerializer::deserialize()} parses an untrusted flattened/general
 * JSON JWS into a {@see \Medzuch\Jwt\Jws\ParsedJsonJws} or rejects it with a
 * {@see JwtException}. Anything else escaping is a bug.
 *
 * Run:
 *   tests/Fuzz/run.sh jws_json
 *
